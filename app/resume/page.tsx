      ...
      <Grid container spacing={2} sx={{ p: 2 }}>
        ...
        <Grid item xs={12} lg={6}>
          <Paper sx={{ p: 2, height: 150 }}>
            ...
            <Typography variant="body2" component="p">
              ...
              the financial services industry. Skilled in HTML, CSS, JavaScript,
        ...
        <Grid item xs={12} lg={6}>
          <Paper sx={{ p: 2, height: 150 }}>
            ...
            <br />
            <Typography variant="body2" component="p">
              Working {dayjs().diff("2017-02-08", "year", true).toFixed(2)}{" "}
              years at Junior Developer at PAAY from February 2017 to Present
            </Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} lg={6}>
